...
CKPT_DIR = PHASE2_ROOT / "outputs/checkpoints/attention_unet_120"
METRIC_DIR = PHASE2_ROOT / "outputs/metrics/attention_unet_120"
FIG_DIR = PHASE2_ROOT / "outputs/figures/attention_unet_120"
...
class AttentionGate(nn.Module):
    """
    Additive attention gate for suppressing irrelevant skip features.
...
class AttentionUNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=5, base_ch=32):
        ...
        self.up1 = UpAttention(base_ch * 16, base_ch * 8, base_ch * 8)
        self.up2 = UpAttention(base_ch * 8, base_ch * 4, base_ch * 4)
        self.up3 = UpAttention(base_ch * 4, base_ch * 2, base_ch * 2)
        self.up4 = UpAttention(base_ch * 2, base_ch, base_ch)
    ...
    def forward(self, x):
        ...
        # Compatible with imported train_one_epoch(), which expects:
        # logits, aux_logits = model(images)
        # aux_weight is set to 0.0, so this does not affect optimization.
...
def main():
    ...
    run_name = (
        f"phase2_attention_unet120_fullval_fold{args.fold}"
    ...
    print("=" * 90)
    print("Phase 2C: Attention U-Net training for 120 epochs")
    print("=" * 90)
    ...
    summary = {
        ...
        "phase": "Phase 2C",
        "model": "Attention U-Net 120 epochs",
        "run_name": run_name,
        "fold": args.fold,
    ...
    summary_path = REPORT_DIR / f"27_phase2_attention_unet120_{run_name}_summary.json"
    ...
    print()
    print("=" * 90)
    print("Phase 2C Attention U-Net 120 training completed")
    print("=" * 90)
    print(f"Fold: {args.fold}")
