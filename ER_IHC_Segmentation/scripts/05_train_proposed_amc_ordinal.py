...
def compute_minority_sampling_weights(train_csv):
    df = pd.read_csv(train_csv)
    ...
    raw = {cls: 1.0 / np.sqrt(counts[cls] + 1.0) for cls in counts}
...
def main():
    ...
    minority_sampling_weights = compute_minority_sampling_weights(train_csv)
