...
CKPT_DIR = OUT_ROOT / "checkpoints/resunetds_baseline"
METRIC_DIR = OUT_ROOT / "metrics/resunetds_baseline"
FIG_DIR = OUT_ROOT / "figures/results/resunetds_baseline"
...
def train_one_epoch(model, loader, optimizer, scaler, device, class_weights, ce_weight, dice_weight, aux_weight):
    model.train()
    ...
    for batch in loader:
        ...
        with torch.cuda.amp.autocast(enabled=device.type == "cuda"):
            ...
            loss = ce_weight * loss_ce + dice_weight * loss_dice + aux_weight * loss_aux
...
def main():
    ...
    run_name = f"resunetds_baseline_fullval_fold{args.fold}_aug-{args.aug_mode}_base{args.base_ch}_crop{args.crop_size}"
    ...
    print("=" * 90)
    print("Phase 4A: ResUNet-DS baseline training")
    print("=" * 90)
    ...
    summary_path = REPORT_DIR / f"04_resunetds_baseline_{run_name}_summary.json"
