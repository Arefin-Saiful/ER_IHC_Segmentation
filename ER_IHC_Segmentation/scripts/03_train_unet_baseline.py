...
class ERIHCDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == "train":
            ...
            image, mask = center_crop_or_resize(image, mask, self.crop_size)
...
def main():
    ...
    run_name = f"unet_baseline_fold{args.fold}_aug-{args.aug_mode}_base{args.base_ch}_crop{args.crop_size}"
