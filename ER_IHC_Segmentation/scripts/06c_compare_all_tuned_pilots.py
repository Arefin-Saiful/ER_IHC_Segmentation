...
RUNS = {
    ...
    "Original proposed ord0.10_ft0.50_amc0.85": {
        "root": PROP_ROOT,
    ...
    "T3 ord0.05_ft0.50_amc0.65": {
        "root": PROP_ROOT,
        "pattern": "proposed_amc_ordinal_fullval_fold{fold}_aug-full_base32_crop320_ord0.05_ft0.5_amcmax0.65_gain0.05_target0.7/best_metrics.json",
    },
    "T4 ord0.10_ft0.50_amc0.65": {
        "root": PROP_ROOT,
        "pattern": "proposed_amc_ordinal_fullval_fold{fold}_aug-full_base32_crop320_ord0.1_ft0.5_amcmax0.65_gain0.05_target0.7/best_metrics.json",
    },
}
...
foldwise_path = OUT_DIR / "pilot_tuning_all_fold0_fold4_comparison.csv"
...
summary_path = OUT_DIR / "pilot_tuning_all_fold0_fold4_summary.csv"
...
delta_path = OUT_DIR / "pilot_tuning_all_fold0_fold4_delta_vs_resunet.csv"
delta.to_csv(delta_path, index=False)

# Simple ranking score:
# Higher Dice/IoU/C2/C4/Kappa is better; lower ordinal MAE is better.
rank = delta.copy()
rank["decision_score"] = (
    ...
    + 0.50 * rank["delta_dice_c4_vs_resunet"]
...
rank_path = OUT_DIR / "pilot_tuning_all_fold0_fold4_ranked.csv"
...
with open(REPORT_DIR / "06c_all_pilot_tuning_comparison_summary.json", "w") as f:
    json.dump(report, f, indent=4)

print("=" * 90)
print("All tuned pilot comparison: folds 0 and 4")
print("=" * 90)
